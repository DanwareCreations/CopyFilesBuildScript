...
:: Makes sure that the copy script fails when the targets file tries to copy-by-replacement a nonexistent file that is already present in the target directory
